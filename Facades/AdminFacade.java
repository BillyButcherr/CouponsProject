...
public class AdminFacade extends ClientFacade{
    ...
    //Works
    public void updateCompany(Company company) throws CompanyNameChangeNotAllowedException, EmptyCompanyIDException {
        if (company.getId() == 0)
    ...
    public void deleteCompany(Company company) throws EmptyCompanyIDException, CompanyDoesNotExistException {
        if(company.getId() == 0)
            throw new EmptyCompanyIDException();
    ...
    //Works
    public Company getOneCompany(int companyID) throws EmptyCompanyIDException, CompanyDoesNotExistException {
        if(companyID == 0)
            throw new EmptyCompanyIDException();
    ...
    public void deleteCustomer(Customer customer) throws EmptyCustomerIDException, CustomerDoesNotExistException {
        if (customer.getId() == 0)
            throw new EmptyCustomerIDException();
        if(customersDAO.getOneCustomer(customer.getId()) == null)
            throw new CustomerDoesNotExistException();
