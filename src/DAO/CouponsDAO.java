...
public interface CouponsDAO {
     ...
     * @param companyID The ID of a company of the coupons.
     * @throws SQLException
     */
    void deleteAllCompanyCoupons(long companyID) throws SQLException;
    /**
     *
     ...
     * @throws SQLException
     */
    void deleteAllCustomerCouponsPurchases(long customerID) throws SQLException;
    /**
     * Deletes all purchases of a given coupon from DB.
     * @param couponID The ID of a coupon whose purchases are to be deleted.
     * @throws SQLException
     */
    void deleteAllCouponPurchases(long couponID) throws SQLException;
}
