...
public class CouponsDBDAO implements CouponsDAO {
     ...
     * @param companyID The ID of the company of whose coupons are to be deleted.
     * @throws SQLException
     */
    @Override
    public void deleteAllCompanyCoupons(long companyID) throws SQLException {
        Connection connection = connectionPool.getConnection();
     ...
     */
    @Override
    public void deleteAllCustomerCouponsPurchases(long customerID) throws SQLException {
        Connection connection = connectionPool.getConnection();
     ...
     * @param couponID The ID of a coupon whose purchases are to be deleted.
     * @throws SQLException
     */
    @Override
    public void deleteAllCouponPurchases(long couponID) throws SQLException{
        Connection connection = connectionPool.getConnection();
