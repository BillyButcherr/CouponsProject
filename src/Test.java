...
public class Test {
    /**
     * Check all CRUD operations for each Bean
     */
    public static void testAll() {
        ...
        try {
            ...
            //adminFacade.deleteCustomer(adminFacade.getOneCustomer(customer1ID));
            System.out.println(adminFacade.getOneCustomer(customer1ID));
